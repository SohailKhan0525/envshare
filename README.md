...
The issues command opens this project's issues page in a browser, for
reporting a problem or suggesting an idea. The star command opens the
project's page so you can show your support, this genuinely helps other
teams discover and trust the project.
...
Open an issue on this project's GitHub page, or simply type envshare
issues to jump straight there. Two starting templates are provided, one
for reporting something broken and one for suggesting something new, so
you will be asked a few short, plain questions to help explain it clearly.
...
See the separate security file in this project for how to privately
report a possible security problem.
...
including at a company, as long as the original notice is kept. See the
separate license file in this project for the full wording.
